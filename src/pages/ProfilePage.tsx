          ...
          <div className="pr-col__card">
            ...
            {profile.resume ? (
              <div className="pr-resume pr-resume--filled">
                <a className="pr-resume__link" href={profile.resume} target="_blank" rel="noreferrer">
              ...
              <div className="pr-resume">
                <div className="pr-resume__placeholder">
                  ...
                  <span className="pr-resume__text">No resume yet</span>
                  <span className="pr-resume__hint">Add one from Edit profile</span>
                </div>
              </div>
            )}
          </div>
